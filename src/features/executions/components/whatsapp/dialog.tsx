    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="border-b px-6 py-5">
          ...
          <DialogDescription>
            Configure the WhatsApp account and message you want to send.
          </DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          <form
            ...
            className="flex max-h-[calc(90vh-130px)] flex-col"
          >
            <div className="flex-1 space-y-6 overflow-y-auto px-6 py-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Use this name to reference the WhatsApp result in
                      other nodes:
                      {" "}
                      <code>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>WhatsApp Credentials</FormLabel>
                    ...
                    <FormDescription>
                      Select the WhatsApp Cloud API credential used to
                      send this message.
                    </FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Enter the recipient's WhatsApp number with country
                      code. You can also use values from previous nodes.
                    </FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Hello {{customer.name}}, your order has been confirmed."
                    ...
                    <FormDescription>
                      ...
                      You can also use the output of an AI node, for
                      example {"{{gemini.text}}"}.
                    </FormDescription>
